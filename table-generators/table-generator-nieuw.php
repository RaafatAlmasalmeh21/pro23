        ...
        if(is_array($dataset) && !empty($dataset)){ 
            ...
            <tr>
                ...
                <?php foreach($dataset as $rows=>$row){ 
                    ...
                    <td>
                        <a href="edit-<?php echo $from1?>.php?ID=<?php echo $row_id; ?>
                        &naam=<?php echo $row['naam']; ?>
                        &telefoonnummer=<?php echo $row['telefoonnummer']; ?>
                        &email=<?php echo $row['email']; ?>
                         " class="edit_btn" >Edit</a>
                    </td>
                    <td>
                        <a href="delete-<?php echo $from1?>.php?ID=<?php echo $row_id; ?>" class="delete_btn" >Delete</a>
                    </td>
                    </tr>
            <?php }
         }
