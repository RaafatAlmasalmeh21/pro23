<?php
 ...
 require_once 'table-generators/table-generator-ober.php';
 $db = new database();

 // de bestellingen worden selected voor de kok
    $act =  $db->select("SELECT bestellingen.ID as bestelling_id, reserveringen.ID as reserverings_id, menu_items.ID, reserveringen.tafel, gerechtsoorten.ID, gerechtcategorien.ID, menu_items.naam, bestellingen.aantal, bestellingen.geserveerd 
    FROM bestellingen 
    ...
    WHERE reserveringen.datum = CURRENT_DATE AND bestellingen.geserveerd = 'klaar om te serveren'");
        ...
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead">
                    <h2>Bestellingen voor de ober</h2>
