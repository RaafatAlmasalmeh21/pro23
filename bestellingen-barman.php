<?php
 ...
 require_once 'table-generators/table-generator-barman.php';
 $db = new database();

 // de bestellingen worden selected voor de barman
    ...
    WHERE reserveringen.datum = CURRENT_DATE AND gerechtcategorien.naam = 'dranken' AND NOT bestellingen.geserveerd = 'geserveerd'
    AND NOT bestellingen.geserveerd = 'Klaar om te serveren'");
        ...
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead">
                    <h2>Bestellingen voor de bar</h2>
